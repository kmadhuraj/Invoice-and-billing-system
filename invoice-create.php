			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					...
					<div class="col-xs-4 no-padding-right">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_date">
				                <input type="text" class="form-control required" name="invoice_date" placeholder="Invoice Date" data-date-format="<?php // mk echo DATE_FORMAT ?>" />
				    ...
				    <div class="col-xs-4">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_due_date">
				                <input type="text" class="form-control required" name="invoice_due_date" placeholder="Due Date" data-date-format="<?php // mk echo DATE_FORMAT ?>" />
				                <span class="input-group-addon">
				                    <span class="glyphicon glyphicon-calendar"></span>
				                </span>
				            </div>
					...
					<div class="input-group col-xs-4 float-right">
						<span class="input-group-addon">#<?php // mk echo INVOICE_PREFIX ?></span>
					...
					<tr>
						...
						<td class="text-right">
							<div class="input-group input-group-sm  no-margin-bottom">
								<span class="input-group-addon"><?php // mk echo CURRENCY ?></span>
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							<?php // mk echo CURRENCY ?><span class="invoice-sub-total">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php // mk echo CURRENCY ?><span class="invoice-discount">0.00</span>
					...
					<?php // mk if (ENABLE_VAT == true) { ?>
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>TAX/VAT:</strong><br>Remove TAX/VAT <input type="checkbox" class="remove_vat">
						</div>
						<div class="col-xs-3">
							<?php // mk echo CURRENCY ?>   <span class="invoice-vat" data-enable-vat="<?php // mk echo ENABLE_VAT ?>" data-vat-rate="<?php // mk echo VAT_RATE ?>" data-vat-method="<?php //echo VAT_INCLUDED ?>">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php // mk echo CURRENCY ?>     <span class="invoice-total">0.00</span>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				<?php // iam commented mk: popProductsList(); ?>
		      </div>
		...
		<div id="insert_customer" class="modal fade">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				<?php // iam commented mk: popCustomersList(); ?>
		      </div>
		      <div class="modal-footer">
				<button type="button" data-dismiss="modal" class="btn">Cancel</button>
		      </div>
